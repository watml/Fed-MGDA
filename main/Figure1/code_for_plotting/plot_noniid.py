...
if __name__ == '__main__':
    ...
    for i in range(n):
        filename[i] = "Ep[{}]_frac[{}]_{}_{}_{}_{}_Mom[{}]_{}_N[{}]_EPS[{}]_{}_iid[{}]_seed[{}]_decay[{}]_prox[{}]_qffl[{}]_Lipsch[{}].pickle".format(
            2000,0.1, 1,10, 0.01, 1.0, 0.0, 'cnn',0 , 0.0, 'cifar', 0, i+1, 1.0, 0.0, 0.0, 1.0)

    # for i in range(n):
    #     filename[i] = "Ep[2000]_frac[0.1]_1_10_0.01_Mom[0.0]_cnn_N[0]_EPS[{}]_cifar_iid[0]_seed[{}].pickle".format(0.0,
    #                                                                                                                i + 1)
    ...
    # for i in range(n):
    #     filename[i] = "Ep[2000]_frac[0.1]_1_10_0.01_Mom[0.0]_cnn_N[0]_EPS[{}]_cifar_iid[0]_seed[{}].pickle".format(0.1,
    #                                                                                                                i + 1)
    ...
    # for i in range(n):
    #     filename[i] = "Ep[2000]_frac[0.1]_1_10_0.01_Mom[0.0]_cnn_N[0]_EPS[{}]_cifar_iid[0]_seed[{}].pickle".format(0.5,
    #                                                                                                                i + 1)
    ...
    # for i in range(n):
    #     filename[i] = "Ep[2000]_frac[0.1]_1_10_0.01_Mom[0.0]_cnn_N[0]_EPS[{}]_cifar_iid[0]_seed[{}].pickle".format(1.0,
    #                                                                                                                i + 1)
    ...
    # for i in range(n):
    #     filename[i] = "Ep[2000]_frac[0.1]_1_10_0.01_Mom[0.0]_cnn_N[0]_EPS[{}]_cifar_iid[0]_seed[{}].pickle".format(0.05,
    #                                                                                                                i + 1)
    ...
    ax1.plot(range(len(avg_train_loss1)), avg_train_loss1, linewidth=4)
    ax1.plot(range(len(avg_train_loss5)), avg_train_loss5, linewidth=4)
    ax1.plot(range(len(avg_train_loss2)), avg_train_loss2, linewidth=4)
    ax1.plot(range(len(avg_train_loss3)), avg_train_loss3, linewidth=4)
    ax1.plot(range(len(avg_train_loss4)), avg_train_loss4, linewidth=4)
    ...
    fig1.savefig('figure1c' + '.eps', format='eps', dpi=600, bbox_inches='tight')
    # noniid_interpolation_loss_thick_nogrid
    ...
    fig2.savefig('figure1a' + '.eps', format='eps', dpi=600, bbox_inches='tight')
    # noniid_interpolation_acc_thick_nogrid
